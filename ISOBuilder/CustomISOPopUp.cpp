...
enum Loc
{
    loc_PageCurrentElement =	ILocalization::Grp_1,
    loc_PageFileSystem,
    loc_ISOLevel1,
    loc_ISOLevel2,
    loc_ISOLevel3,
...
CustomISOPopUp::CustomISOPopUp(const Globals &glb) :
    MUIPopup(0),
    Glb(glb)
{
    hHkBtnHook.Initialize(this, &CustomISOPopUp::buttonHandler);
...
CustomISOPopUp::~CustomISOPopUp()
{
}

bool CustomISOPopUp::onOpen()
{
    setElement(elem);
    setBrowser(browser);
    return true;
...
bool CustomISOPopUp::onClose()
{
    return true;
}

iptr *CustomISOPopUp::getPopDisplay()
{
...
iptr *CustomISOPopUp::getPopButton()
{
    return PopButton(MUII_PopUp);
}

iptr *CustomISOPopUp::getPopObject()
{
...
void CustomISOPopUp::setValue(const void* string)
{
    muiSetText(ID_String, (const char*)string);
}

const void *CustomISOPopUp::getValue()
{
    return value.Data();
}

iptr CustomISOPopUp::buttonHandler(int id, void* data)
{
    switch ((BtnID)id)
    {
	case ID_String:
...
iptr *CustomISOPopUp::getObject()
{
    MUIPopup::getObject();
    return all;
}

iptr *CustomISOPopUp::getISOSettings()
{
    ...
    return VGroup,
	   ...
	   Child,         muiLabel(Glb.Loc[loc_ISOLevel], Glb.Loc.Accel(loc_ISOLevel), ID_Default, 0, Align_Right),
	   Child,         muiCycle(levels, Glb.Loc.Accel(loc_ISOLevel), ID_ISOLevel),

	   Child,         muiLabel(Glb.Loc[loc_AddRockRidge], Glb.Loc.Accel(loc_AddRockRidge), ID_Default, 0, Align_Right),
	   Child,         muiCheckBox(0, Glb.Loc.Accel(loc_AddRockRidge), ID_AddRockRidge),

	   Child,         muiLabel(Glb.Loc[loc_AddJoliet], Glb.Loc.Accel(loc_AddJoliet), ID_Default, 0, Align_Right),
	   Child,         muiCheckBox(0, Glb.Loc.Accel(loc_AddJoliet), ID_AddJoliet),

	   Child,         muiLabel(Glb.Loc[loc_RelaxedISO], Glb.Loc.Accel(loc_RelaxedISO), ID_Default, 0, Align_Right),
	   ...
	   Child,         muiLabel(Glb.Loc[loc_DiscName], Glb.Loc.Accel(loc_DiscName), ID_Default, 0, Align_Right),
	   Child,         muiString(0, Glb.Loc.Accel(loc_DiscName), ID_VolumeName),

	   Child,         muiLabel(Glb.Loc[loc_DiscSetName], Glb.Loc.Accel(loc_DiscSetName), ID_Default, 0, Align_Right),
	   Child,         muiString(0, Glb.Loc.Accel(loc_DiscSetName), ID_VolumeSetName),

	   Child,         muiLabel(Glb.Loc[loc_System], Glb.Loc.Accel(loc_System), ID_Default, 0, Align_Right),
	   Child,         muiString(0, Glb.Loc.Accel(loc_System), ID_SystemType),

	   Child,         muiLabel(Glb.Loc[loc_Publisher], Glb.Loc.Accel(loc_Publisher), ID_Default, 0, Align_Right),
	   Child,         muiString(0, Glb.Loc.Accel(loc_Publisher), ID_Publisher),

	   Child,         muiLabel(Glb.Loc[loc_Preparer], Glb.Loc.Accel(loc_Preparer), ID_Default, 0, Align_Right),
	   Child,         muiString(0, Glb.Loc.Accel(loc_Preparer), ID_Preparer),

	   Child,         muiLabel(Glb.Loc[loc_Application], Glb.Loc.Accel(loc_Application), ID_Default, 0, Align_Right),
...
void CustomISOPopUp::setBrowser(ClISO* pBser)
{
    browser = pBser;
    if (browser != NULL)
    {
...
void CustomISOPopUp::setElement(ClElement *pElem)
{
    elem = pElem;
    if (NULL != elem)
    {
...
iptr *CustomISOPopUp::getElemSettings()
{
    return VGroup,
	   Child,         ColGroup(2),
	   MUIA_Group_SameSize, true,
	   ...
	   Child,         muiLabel(Glb.Loc[loc_OrigName], Glb.Loc.Accel(loc_OrigName), ID_Default, 0, Align_Right),
	   Child,         muiString(0, Glb.Loc.Accel(loc_OrigName), ID_NormalName),

	   Child,         muiLabel(Glb.Loc[loc_ISOName], Glb.Loc.Accel(loc_ISOName), ID_Default, 0, Align_Right),
	   Child,         muiLabel("---", 0, ID_ISOName, 100, Align_Left),

	   Child,         muiLabel(Glb.Loc[loc_RRName], Glb.Loc.Accel(loc_RRName), ID_Default, 0, Align_Right),
	   Child,         muiString(0, Glb.Loc.Accel(loc_RRName), ID_RRName),

	   Child,         muiLabel(Glb.Loc[loc_JolietName], Glb.Loc.Accel(loc_JolietName), ID_Default, 0, Align_Right),
	   Child,         muiString(0, Glb.Loc.Accel(loc_JolietName), ID_JolietName),

	   Child,         muiLabel(Glb.Loc[loc_Comment], Glb.Loc.Accel(loc_Comment), ID_Default, 0, Align_Right),
	   ...
	   Child,         muiLabel(Glb.Loc[loc_ShowInISO], Glb.Loc.Accel(loc_ShowInISO), ID_Default, 0, Align_Right),
	   Child,         muiCheckBox(0, Glb.Loc.Accel(loc_ShowInISO), ID_AddISOEntry),

	   Child,         muiLabel(Glb.Loc[loc_ShowInRR], Glb.Loc.Accel(loc_ShowInRR), ID_Default, 0, Align_Right),
	   Child,         muiCheckBox(0, Glb.Loc.Accel(loc_ShowInRR), ID_AddRREntry),

	   Child,         muiLabel(Glb.Loc[loc_ShowInJoliet], Glb.Loc.Accel(loc_ShowInJoliet), ID_Default, 0, Align_Right),
...
void CustomISOPopUp::setEnabled(bool enabled)
{
    Intuition->SetAttrsA(all, (TagItem*)ARRAY(MUIA_Disabled, !enabled, TAG_DONE, 0));
}

bool CustomISOPopUp::InitLocale(Globals& glb)
{
