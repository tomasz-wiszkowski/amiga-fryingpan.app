...
enum EOptCommand
{
    ...
    /** Scan device; returns ScanData structure
     */
    DRV_ScanDevice,
...
{
    DRT_Blank_Default		=   0,
    DRT_Blank_Erase_Complete,
    DRT_Blank_Erase_Fast,
    DRT_Blank_Erase_Session,
    DRT_Blank_Format_Complete	=   100,
    DRT_Blank_Format_Fast,
};
...
enum DRT_OperationStatus
{
    DRT_OpStatus_Ready,		    /* drive ready */
    DRT_OpStatus_InProgress,	    /* operation status update */
    DRT_OpStatus_Completed,	    /* operation complete (success or failure) */
    DRT_OpStatus_Aborted
};
...
enum DRT_Operation
{
    ...
    DRT_Operation_Ready,	    /* Device ready to accept more ops */
    DRT_Operation_OpeningTray,	    /* opening tray, user pressed button */
    DRT_Operation_ClosingTray,	    /* closing tray, user pressed button */
    DRT_Operation_IdleNoDisc,	    /* idle, no disc in drive */

    ///***************************************** playback control
    DRT_Operation_Play = 0x1000,     /* playing audio disc */
    DRT_Operation_Pause,             /* play suspended */
    DRT_Operation_Read,              /* reading data */
    /// other operations ////////////

    ///***************************************** drive control
    DRT_Operation_Control_General = 0x2000,   /* generic control unit */
    ...
    DRT_Operation_Control_Lock,		      /* lock tray */
    DRT_Operation_Control_Unlock,	      /* unlock tray */
    ///***************************************** other types may follow.

    ///***************************************** drive & disc analysis
    DRT_Operation_Analyse_General = 0x3000,   /* general analyze */
    ...
    DRT_Operation_Write_General = 0x4000,     /* write in general */
    ...
    DRT_Operation_Erase_General = 0x5000,     /* general erase */
...
{
public:
    virtual IDriveClient*   OpenDrive(const char* name, int unit) = 0;
};
