...
uint32 *MUI::muiCheckBox(const char* name, char key, int id, Alignment align, bool state)
{
   ...
   DoMtd(all, ARRAY(MUIM_Notify, MUIA_Selected, MUIV_EveryTime, (int)all, 4, MUIM_CallHook, (int)gateBtns.GetHook(), id, MUIV_TriggerValue));
...
uint32 *MUI::muiSlider(int32 min, int32 max, int32 level, char key, int id)
{
   ...
   DoMtd(slider, ARRAY(MUIM_Notify, MUIA_Numeric_Value, MUIV_EveryTime, (int)slider, 4, MUIM_CallHook, (int)gateBtns.GetHook(), id, MUIV_TriggerValue));
...
uint32 *MUI::muiString(const char* contents, char key, int id, Alignment align)
{
   ...
   DoMtd(all, ARRAY(MUIM_Notify, MUIA_String_Acknowledge, MUIV_EveryTime, (int)all, 4, MUIM_CallHook, (int)gateBtns.GetHook(), id, MUIV_TriggerValue));
