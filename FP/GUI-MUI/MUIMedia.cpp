...
enum Loc
{
    ...
    loc_ReqEraseDisc		= lg_Media + ls_Req,
};
...
static class Localization::LocaleSet LocaleSets[] =
{
    ...
    {  loc_BtnChangeProtection,"w&Switch WriteProtect", "BTN_WRITEPROTECT"},
    ...
    {	loc_ReqEraseDisc,
	"Are you sure you want to erase the disc?\n"
	    "The data on this disc may be no longer available\n"
    ...
    Glb(glb)
{
    ...
    preptype = Config->getValue(Cfg_PrepMethod, (iptr)0);
...
iptr *MUIMedia::getObject()
{
	...
	Child,                  muiLabel(Glb.Loc[loc_MediumType], 0, ID_Default, 100, Align_Right),
	Child,                  muiLabel("---", 0, ID_DiscType, 100, Align_Left),
	Child,                  muiLabel(Glb.Loc[loc_MediumSubType], 0, ID_Default, 100, Align_Right),
	Child,                  muiLabel("---", 0, ID_SubType, 100, Align_Left),
	Child,                  muiLabel(Glb.Loc[loc_MediumVendor], 0, ID_Default, 100, Align_Right),
	Child,                  muiLabel("---", 0, ID_Vendor, 100, Align_Left),
	Child,                  muiLabel(Glb.Loc[loc_MediumState], 0, ID_Default, 100, Align_Right),
	Child,                  muiLabel("---", 0, ID_State, 100, Align_Left),
	Child,                  muiLabel(Glb.Loc[loc_MediumContents], 0, ID_Default, 100, Align_Right),
	Child,                  muiLabel("---", 0, ID_Contents, 100, Align_Left),
	Child,                  muiLabel(Glb.Loc[loc_MediumID], 0, ID_Default, 100, Align_Right),
	Child,                  muiLabel("---", 0, ID_DiscID, 100, Align_Left),
	Child,                  muiLabel(Glb.Loc[loc_MediumBarCode], 0, ID_Default, 100, Align_Right),
	Child,                  muiLabel("---", 0, ID_BarCode, 100, Align_Left),
	Child,                  muiLabel(Glb.Loc[loc_MediumMCN], 0, ID_Default, 100, Align_Right),
	Child,                  muiLabel("---", 0, ID_Catalog, 100, Align_Left),
	Child,                  muiLabel(Glb.Loc[loc_MediumSize], 0, ID_Default, 100, Align_Right),
	Child,                  muiLabel("---", 0, ID_DiscSize, 100, Align_Left),
	Child,                  muiLabel(Glb.Loc[loc_MediumReadSpeeds], 0, ID_Default, 100, Align_Right),
	Child,                  muiLabel("---", 0, ID_ReadSpeeds, 100, Align_Left),
	Child,                  muiLabel(Glb.Loc[loc_MediumWriteSpeeds], 0, ID_Default, 100, Align_Right),
	Child,                  muiLabel("---", 0, ID_WriteSpeeds, 100, Align_Left),
	End,
	...
	Child,                  muiButton(Glb.Loc[loc_BtnChangeProtection], Glb.Loc.Accel(loc_BtnChangeProtection), ID_ChangeProtection),
	End,
...
iptr MUIMedia::buttonClicked(BtnID id, int32 state)
{
	...
	case ID_EraseDisc:
	    if (request(Glb.Loc[Globals::loc_Warn], Glb.Loc[loc_ReqEraseDisc], Glb.Loc[Globals::loc_YesNo], 0))
	    {
		if (preptype == 0)
		    pEng->quickErase();
		else
	...
	case ID_ChangeProtection:
	    {
		pEng->setDiscWriteProtected(!pEng->isDiscWriteProtected());
	    }
	    break;
...
String MUIMedia::stateToString()
{
    ...
    if (pEng->isDiscWriteProtected())
	res += "WriteProtected ";
    else if (pEng->isDiscWriteProtectable())
	res += "WriteProtectable ";
...
String MUIMedia::profileToString()
{
	...
	case DRT_Profile_BD_R_Sequential:
	    s = "BD-R (Sequential Recording)";
	    break;

	case DRT_Profile_BD_R_PseudoOverwrite:
	    s = "BD-R (Pseudo Overwrite)";
	    break;

	case DRT_Profile_BD_R_RandomWrite:
	    s = "BD-R (Random Recording)";
	    break;
